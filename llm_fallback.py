...
# Модель по умолчанию — результат замера benchmark_models.py на 16 эталонных
# сайтах: 100% попаданий при 24 ₽ на 1000 сайтов. Столько же взяли
# deepseek-chat-v3.1 (48 ₽) и claude-haiku-4.5 (315 ₽) — переплата за тот же
# результат в 2 и 13 раз.
