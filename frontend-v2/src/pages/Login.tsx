...
const PROVIDERS: Array<{ id: Provider; name: string; color: string; icon: () => ReactElement }> = [
...
export function Login() {
  ...
  return (
    <div className="supplydesk-login relative isolate flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#070b17] px-5 py-0 text-white sm:px-8">
      <style>{`
